...
<div class="container">
    ...
    <form:form action="${pageContext.request.contextPath}/editMovie" method="post" modelAttribute="movie" enctype="multipart/form-data">
        <form:hidden path="id"/>
        ...
        <div class="form-group">
            <label for="posterFile">Poster (leave empty to keep current):</label>
            ...
            <c:if test="${not empty movie.poster}">
                <img src="${movie.poster}" alt="Current Poster" style="width:100px; margin-top:10px;">
            </c:if>
        </div>
