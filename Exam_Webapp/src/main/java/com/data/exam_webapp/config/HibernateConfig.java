package com.data.exam_webapp.config;
...
@ComponentScan(basePackages = "com.data.exam_webapp")
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/exam_webapp");
        ds.setUsername("root");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sf.setPackagesToScan("com.data.exam_webapp.entity"); // Chỉ định package chứa các @Entity
